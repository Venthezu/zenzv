  ...
  return (
    <header className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-4 flex justify-between items-center shadow-md">
      ...
      >
        ...
        <a href="https://wa.me/yourwa" target="_blank" className="block hover:underline">WhatsApp</a>
        <a href="https://t.me/yourtele" target="_blank" className="block hover:underline">Telegram</a>
      </nav>
    </header>
  );
}
